    ...
    for it in range(num_iter):
        for alpha, beta in alpha_betas:
            for k in ks:
                ...
                io_utils.save_community(model.pi, model.vocab_t, file_name="{}_alpha-{}_beta-{}_ws-{}_neg-{}_lr-{}_icom-{}_ind-{}_k-{}_ds-{}.pi".format(
                                            output_file, alpha, beta, window_size, negative, lr, iter_com, iter_node, model.k, down_sampling))
